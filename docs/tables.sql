CREATE TABLE k(
  ...
  `created_time` int DEFAULT 0 NOT NULL COMMENT 'created tiem',
  `updated_time` int DEFAULT 0 NOT NULL COMMENT 'updated tiem',
...
CREATE TABLE social_account(
  ...
  created_time int(10) DEFAULT 0 NOT NULL COMMENT 'created tiem',
  updated_time int(10) DEFAULT 0 NOT NULL COMMENT 'updated tiem',
...
create TABLE resume(
  ...
  is_valid tinyint(1) DEFAULT 0 NOT NULL COMMENT '是否为有效简历',
